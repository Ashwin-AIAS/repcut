...
description: Builds Prompt 11's copilot — natural language to edit-plan operations via Gemini function calling. Use only for Prompt 11 and later copilot work. Deferred until Wave 3.
